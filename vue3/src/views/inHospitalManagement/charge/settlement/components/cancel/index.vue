  ...
  <div class="hospitalizationSettlementCancel-container">
    ...
    <div class="billData-container">
      <el-table :data="queryPpatientList" height="186px" show-overflow-tooltip :style="{ height: '100%' }">
        ...
        <el-table-column prop="costs" label="金额" width="160" align="right" header-align="left" :formatter="(row: any) => {
        ...
        <el-table-column prop="createdDate" label="结算时间" min-width="194" :formatter="(row: any) => {
